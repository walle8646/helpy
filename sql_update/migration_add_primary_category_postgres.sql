-- ============================================================================
-- MIGRATION: Aggiungi colonna primary_category_id a community_questions (PostgreSQL)
-- ============================================================================

-- Aggiungi la colonna primary_category_id se non esiste
ALTER TABLE community_questions ADD COLUMN IF NOT EXISTS primary_category_id INTEGER REFERENCES category(id);
