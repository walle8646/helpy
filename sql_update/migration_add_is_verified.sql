-- ================================================
-- MIGRATION: Aggiungi campo is_verified e user_type alla tabella user - SQLITE
-- ================================================
...
INSERT OR IGNORE INTO user_type (id, name, description) VALUES
...
ALTER TABLE user ADD COLUMN is_verified INTEGER DEFAULT 0;

-- 4. Aggiungi campo user_type_id alla tabella user
ALTER TABLE user ADD COLUMN user_type_id INTEGER DEFAULT 1 REFERENCES user_type(id);

-- 5. Opzionale: aggiorna utenti esistenti (esempio: verifica chi ha almeno 3 bollini)
-- UPDATE user SET is_verified = 1 WHERE bollini >= 3;
